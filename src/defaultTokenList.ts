...
const tokens: TokenWithURI[] = [
  // Ethereum
  new TokenWithURI(ETHEREUM_CHAIN_ID, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, WETH, names[WETH], logos[WETH]),
  new TokenWithURI(ETHEREUM_CHAIN_ID, '0x8d0D000Ee44948FC98c9B98A4FA4921476f08B0d', 18, USD1, names[USD1], logos[USD1]),
  new TokenWithURI(ETHEREUM_CHAIN_ID, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, USDC, names[USDC], logos[USDC]),
  // Arbitrum
